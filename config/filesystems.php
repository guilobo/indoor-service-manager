    ...
    */
    ...
    'disks' => [
        ...
        'public' => [
            ...
            'connect_timeout' => (int) env('GEL5_FILES_CONNECT_TIMEOUT', 10),
            'timeout' => (int) env('GEL5_FILES_TIMEOUT', 300),
            'retries' => (int) env('GEL5_FILES_RETRIES', 2),
            'retry_sleep' => (int) env('GEL5_FILES_RETRY_SLEEP', 500),
            'visibility' => 'public',
            'throw' => false,
            'report' => false,
        ],
