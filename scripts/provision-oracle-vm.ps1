...
LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME="60"
...
LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME="${LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME:-60}"
...
GEL5_FILES_TIMEOUT="${GEL5_FILES_TIMEOUT:-900}"
