...
LIVEWIRE_TEMP_UPLOAD_DIRECTORY="livewire-tmp"
LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME="20"
...
GEL5_FILES_CONNECT_TIMEOUT="10"
GEL5_FILES_TIMEOUT="300"
GEL5_FILES_RETRIES="2"
GEL5_FILES_RETRY_SLEEP="500"
MAIL_MAILER="log"
...
LIVEWIRE_TEMP_UPLOAD_DISK="${LIVEWIRE_TEMP_UPLOAD_DISK:-local}"
LIVEWIRE_TEMP_UPLOAD_DIRECTORY="${LIVEWIRE_TEMP_UPLOAD_DIRECTORY:-livewire-tmp}"
LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME="${LIVEWIRE_TEMP_UPLOAD_MAX_UPLOAD_TIME:-20}"
...
GEL5_FILES_CONNECT_TIMEOUT="${GEL5_FILES_CONNECT_TIMEOUT:-10}"
GEL5_FILES_TIMEOUT="${GEL5_FILES_TIMEOUT:-300}"
GEL5_FILES_RETRIES="${GEL5_FILES_RETRIES:-2}"
GEL5_FILES_RETRY_SLEEP="${GEL5_FILES_RETRY_SLEEP:-500}"
